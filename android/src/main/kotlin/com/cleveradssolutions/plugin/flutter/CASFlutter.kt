...
class CASFlutter: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    val test = flutterPluginBinding
      .platformViewRegistry
      .registerViewFactory("<cas-banner-view>", BannerViewFactory(this::getCASBridge, flutterPluginBinding.binaryMessenger))

    channel =
      MethodChannel(flutterPluginBinding.binaryMessenger, "com.cleveradssolutions.cas.ads.flutter")
  ...
  private fun withTestAdMode(call: MethodCall, result: Result) {
    ...
    getCASBridgeBuilder()?.withTestMode(enabled) ?: return result.error(errorTag, "failed to get CASBridgeBuilder", null)
  ...
  private fun setUserId(call: MethodCall, result: Result) {
    ...
    getCASBridgeBuilder()
      ?.setUserId(userId) ?: return result.error(errorTag, "failed to get CASBridgeBuilder", null)
  ...
  private fun addExtras(call: MethodCall, result: Result) {
    ...
    getCASBridgeBuilder()
      ?.addExtras(key, value) ?: return result.error(errorTag, "failed to get CASBridgeBuilder", null)
  ...
  private fun build(call: MethodCall, result: Result) {
    ...
    casBridge = getCASBridgeBuilder()
      ?.build(id, version, formats, getCASConsentFlow()) ?: return result.error(errorTag, "failed to get CASBridgeBuilder", null)
  ...
  private fun createBannerView(call: MethodCall, result: Result) {
    val casBridgeTemp = getCASBridge() ?: return result.error(errorTag, "failed to get CASBridgeBuilder", null)
    ...
    if (banners.containsKey(sizeId)) {
      ...
      val casBannerView = when (sizeId) {
        ...
        5 -> casBridgeTemp.createAdView(bannerMRECCallbackWrapper, sizeId)
          ...
          casBridgeTemp.createAdView(bannerStandardCallbackWrapper, 1);
        }
      }
  ...
  private fun initCallbacks() {
    ...
    initializationCallbackWrapper =
      CASInitCallback { error, countryCode, isConsentRequired, isTestMode ->
        invokeChannelMethod("onCASInitialized", mapOf(
          "error" to error,
    ...
    consentFlowDismissListener =
      CASConsentFlowDismissListener { status -> invokeChannelMethod("OnDismissListener",
    ...
    interstitialCallbackWrapper = object : CASCallback {
      ...
      override fun onFailed(error: Int) {
        invokeChannelMethod("OnInterstitialAdFailedToLoad", mapOf("message" to AdError(error).message))
      }
    ...
    rewardedCallbackWrapper = object : CASCallback {
      ...
      override fun onFailed(error: Int) {
        invokeChannelMethod("OnRewardedAdFailedToLoad", mapOf("message" to AdError(error).message))
      }
    ...
    bannerStandardCallbackWrapper = object : CASCallback {
      ...
      override fun onFailed(error: Int) {
        invokeChannelMethod("1OnBannerAdFailedToLoad", mapOf("message" to AdError(error).message))
      }
      ...
      override fun onRect(x: Int, y: Int, width: Int, height: Int) {
        invokeChannelMethod("1OnBannerAdRect", hashMapOf(
          "x" to x,
          "y" to y,
          "width" to width,
          "height" to height
    ...
    bannerAdaptiveCallbackWrapper = object : CASCallback {
      ...
      override fun onFailed(error: Int) {
        invokeChannelMethod("2OnBannerAdFailedToLoad", mapOf("message" to AdError(error).message))
      }
      ...
      override fun onRect(x: Int, y: Int, width: Int, height: Int) {
        invokeChannelMethod("2OnBannerAdRect", hashMapOf(
          "x" to x,
          "y" to y,
          "width" to width,
          "height" to height
    ...
    bannerSmartCallbackWrapper = object : CASCallback {
      ...
      override fun onFailed(error: Int) {
        invokeChannelMethod("3OnBannerAdFailedToLoad", mapOf("message" to AdError(error).message))
      }
      ...
      override fun onRect(x: Int, y: Int, width: Int, height: Int) {
        invokeChannelMethod("3OnBannerAdRect", hashMapOf(
          "x" to x,
          "y" to y,
          "width" to width,
          "height" to height
    ...
    bannerLeaderCallbackWrapper = object : CASCallback {
      ...
      override fun onFailed(error: Int) {
        invokeChannelMethod("4OnBannerAdFailedToLoad", mapOf("message" to AdError(error).message))
      }
      ...
      override fun onRect(x: Int, y: Int, width: Int, height: Int) {
        invokeChannelMethod("4OnBannerAdRect", hashMapOf(
          "x" to x,
          "y" to y,
          "width" to width,
          "height" to height
    ...
    bannerMRECCallbackWrapper = object : CASCallback {
      ...
      override fun onFailed(error: Int) {
        invokeChannelMethod("5OnBannerAdFailedToLoad", mapOf("message" to AdError(error).message))
      }
      ...
      override fun onRect(x: Int, y: Int, width: Int, height: Int) {
        invokeChannelMethod("5OnBannerAdRect", hashMapOf(
          "x" to x,
          "y" to y,
          "width" to width,
          "height" to height
    ...
    activity?.runOnUiThread {
      channel.invokeMethod(methodName, args, object : Result {
        ...
        override fun error(errorCode: String, errorMessage: String?, errorDetails: Any?) {
          Log.e(errorTag, "Error: invokeMethod $methodName failed "
